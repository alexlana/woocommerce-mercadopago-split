...
class WC_WooMercadoPagoSplit_Helpers_CurrencyConverter
{
     ...
     * @return $this
     */
    private function init(WC_WooMercadoPagoSplit_PaymentAbstract $method)
    {
     ...
     * @return mixed|null
     */
    private function getAccountCurrency(WC_WooMercadoPagoSplit_PaymentAbstract $method)
    {
        $key = $method->id;
     ...
     * @return mixed
     */
    private function getAccessToken(WC_WooMercadoPagoSplit_PaymentAbstract $method)
    {
     ...
     * @return mixed
     */
    public function isEnabled(WC_WooMercadoPagoSplit_PaymentAbstract $method)
    {
     ...
     * @return int|mixed
     */
    private function getRatio(WC_WooMercadoPagoSplit_PaymentAbstract $method)
    {
        $this->init($method);
     ...
     * @return int
     */
    public function loadRatio($fromCurrency, $toCurrency, WC_WooMercadoPagoSplit_PaymentAbstract $method = null)
    {
        ...
        try {
            ...
            $this->log->write_log(
                "WC_WooMercadoPagoSplit_Helpers_CurrencyConverter::loadRatio('$fromCurrency', '$toCurrency')",
                $e->__toString()
            );
     ...
     * @return float
     */
    public function ratio(WC_WooMercadoPagoSplit_PaymentAbstract $method)
    {
        $this->init($method);
     ...
     * @return string|void
     */
    public function getDescription(WC_WooMercadoPagoSplit_PaymentAbstract $method)
    {
     ...
     * @return bool
     */
    private function isCurrencySupported($currency, WC_WooMercadoPagoSplit_PaymentAbstract $method)
    {
     ...
     * @return array|bool
     */
    public function getSupportedCurrencies(WC_WooMercadoPagoSplit_PaymentAbstract $method)
    {
     ...
     * @return array
     */
    public function getField(WC_WooMercadoPagoSplit_PaymentAbstract $method)
    {
        return array(
     ...
     * @param $newData
     */
    public function scheduleNotice(WC_WooMercadoPagoSplit_PaymentAbstract $method, $oldData, $newData)
    {
     ...
     * @param WC_WooMercadoPagoSplit_PaymentAbstract $method
     */
    public function notices(WC_WooMercadoPagoSplit_PaymentAbstract $method)
    {
     ...
     * @return string
     */
    public function noticeEnabled(WC_WooMercadoPagoSplit_PaymentAbstract $method)
    {
        $localCurrency = get_woocommerce_currency();
        ...
        return WC_WooMercadoPagoSplit_Notices::getAlertFrame($message, $type);
    }
     ...
     * @return string
     */
    public function noticeDisabled(WC_WooMercadoPagoSplit_PaymentAbstract $method)
    {
        $localCurrency = get_woocommerce_currency();
        $currency = $this->getAccountCurrency($method);
     ...
     * @return string
     */
    public function noticeWarning(WC_WooMercadoPagoSplit_PaymentAbstract $method)
    {
