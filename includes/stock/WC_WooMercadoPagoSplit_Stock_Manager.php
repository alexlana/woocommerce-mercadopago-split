...
class WC_WooMercadoPagoSplit_Stock_Manager
{
    ...
    public function __construct()
    {
        ...
        add_action('woocommerce_order_status_pending_to_cancelled', array('WC_WooMercadoPagoSplit_Stock_Manager', 'restore_stock_item'), 10, 1);
        add_action('woocommerce_order_status_pending_to_failed', array('WC_WooMercadoPagoSplit_Stock_Manager', 'restore_stock_item'), 10, 1);

        // Mp status approved logic
        add_action('woocommerce_order_status_processing_to_refunded', array('WC_WooMercadoPagoSplit_Stock_Manager', 'restore_stock_item'), 10, 1);
        add_action('woocommerce_order_status_on-hold_to_refunded', array('WC_WooMercadoPagoSplit_Stock_Manager', 'restore_stock_item'), 10, 1);
    }
