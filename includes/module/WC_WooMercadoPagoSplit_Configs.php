...
class WC_WooMercadoPagoSplit_Configs
{
    ...
    private function updateToken()
    {
        ...
        if ($mpInstance) {
            if (
                WC_WooMercadoPagoSplit_Credentials::validateCredentialsTest($mpInstance, null, get_option('_mp_public_key')) == true
                && WC_WooMercadoPagoSplit_Credentials::validateCredentialsTest($mpInstance, get_option('_mp_access_token')) == true
            ) {
            ...
            if (
                WC_WooMercadoPagoSplit_Credentials::validateCredentialsProd($mpInstance, null, get_option('_mp_public_key')) == true
                && WC_WooMercadoPagoSplit_Credentials::validateCredentialsProd($mpInstance, get_option('_mp_access_token')) == true
            ) {
            ...
            update_option('_mp_appid', get_option('_mp_public_key'), true);
            update_option('_mp_returnurl', get_option('_mp_public_key'), true);
